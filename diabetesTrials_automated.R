...
########################
if (saveData){
  saveRDS(joinedTable, file = "diabetesRdata_11_11_2020.rds")
  write.csv(designTrialExamineExperimentalOnly,'experimentalOnly_11_11_2020.csv')
  write.csv(joinedTable,'diabetesTableTotal_11_11_2020.csv')
  write.csv(joinedTableDiverseDiscontinued,'diabetesTableDiscDiverse_11_11_2020.csv')
  write.csv(joinedTableSummarizeInterv,'diabetesTableInterv_11_11_2020.csv')
  write.csv(joinedTableSummarizeType,'diabetesTableType_11_11_2020.csv')
  write.csv(joinedTableSummarizePhase,'diabetesTablePhase_11_11_2020.csv')
  write.csv(joinedTableSummarizeAgency,'diabetesTableAgency_11_11_2020.csv')
  write.csv(joinedTableSummarizeReported,'diabetesTableReported_11_11_2020.csv')
  write.csv(joinedTableSummarizeSite,'diabetesTableSite_11_11_2020.csv')
  write.csv(joinedTableSummarizeStatus,'diabetesTableStatus_11_11_2020.csv')
  write.csv(joinedTableSummarizeOverallStatus,'diabetesTableOverallStatus_11_11_2020.csv')
  write.csv(joinedTableSummarizePubCount,'diabetesTablePubCount_11_11_2020.csv')
}
...
print(pInd)
if (savePlot){
  ggsave("trialsByYearMultiArm_11_11_2020.png", units="in", width=6, height=4, dpi=600)
}
...
print(pHist)
if (savePlot){
  ggsave("trialsByYearHist_11_11_2020.png", units="in", width=5, height=4, dpi=600)
}
